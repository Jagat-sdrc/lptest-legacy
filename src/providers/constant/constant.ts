...
*/
  ...
  static serverUrls:any = {
    // SERVER_STATUS: 'http://uat.sdrc.co.in/lactation/serverStatus',
    // SYNCHRONIZE: 'http://uat.sdrc.co.in/lactation/sync'
    SERVER_STATUS: 'http://test.sdrc.co.in/lactationtest/serverStatus',
    SYNCHRONIZE: 'http://test.sdrc.co.in/lactationtest/sync'
